...
CREATE TABLE `business` (
  ...
  `type` enum('House','Bakery','School','Cafe','Pharmacy','Bank','Grocery','Hardware') DEFAULT NULL,
...
INSERT INTO `business` VALUES (1,'ABC Bakery','Bakery','Cauayan City');
...
CREATE TABLE `electric_readings` (
  ...
  `electric_meter_id` int DEFAULT NULL,
  ...
  KEY `electric_meter_id` (`electric_meter_id`),
...
INSERT INTO `water_bills` VALUES (1,1,30.00,33.25,50.00,1047.50,'Unpaid',NULL);
...
CREATE TABLE `water_readings` (
  ...
  CONSTRAINT `fk_water_readings_encoded_by` FOREIGN KEY (`encoded_by`) REFERENCES `employees` (`employees_id`),
...
-- Dump completed on 2026-02-15 15:34:30
